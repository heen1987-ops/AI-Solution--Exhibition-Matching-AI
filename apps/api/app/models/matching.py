...
class MatchRun(Base):
    ...
    cold_start_policy_version_id: Mapped[uuid.UUID | None] = mapped_column(
        PGUUID(as_uuid=True),
        ForeignKey(f"{SCHEMA_MATCHING}.match_policy_version.match_policy_version_id"),
        nullable=True,
    )
    cold_start_details: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, nullable=True
    )
...
class MatchResult(Base):
    ...
    cold_start_details: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
