...
> and `apps/api/app/models/**` (27 mapped domain modules plus `common.py`, 31 Alembic migrations,
> single head `0031_integration_source_sync`, 135 tables, SQL-compile verified). This file is a
